...
const HomePage = () => {
  ...
  // MOCK sponsor data
  const sponsors = [
    { name: "Apollo Children", logo: "https://via.placeholder.com/150x150/FFD700/000000?text=Apollo" },
    { name: "ADR Medical", logo: "https://via.placeholder.com/150x150/FF00FF/FFFFFF?text=ADR" },
    { name: "3B Scientific", logo: "https://via.placeholder.com/150x150/00BFFF/000000?text=3B" },
    { name: "BOHR Labs", logo: "https://via.placeholder.com/150x150/32CD32/000000?text=BOHR" },
    { name: "Cerebellum", logo: "https://via.placeholder.com/150x150/FF6347/FFFFFF?text=Cerebellum" },
    { name: "DBMCI", logo: "https://via.placeholder.com/150x150/FFD700/000000?text=DBMCI" },
  ];
